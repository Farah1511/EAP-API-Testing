...
// Empty Token
  ...
  // test('API call for missing auth header', async () => {
  //   const newRequest = await request.newContext(); // No token or headers set
  //   const response = await newRequest.post(endpoint, {
  //     data: samplePayload,
  //   });
...
// Post Template
// import payload from '../../../data/payloads/profile/updateProfile.json';
// const response = await request.post('/gateway/api/....', { data: payload });
